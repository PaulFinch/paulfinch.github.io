...
tags:   arduino 
---
{% assign folder = {{ site.baseurl }}/assets/{{ post.title | replace: "_", " " }} %}
...
![Looping]({{ folder }}/Images/Looping.jpg)

## Hardware ##
![L293D]({{ folder }}/Images/L293D.png)
...
![Voltmeter]({{ folder }}/Images/Voltmeter.jpg)
...
## Wiring ##
![Schematic]({{ folder }}/Fritzing/Schematic.png)
...
## Enclosure ##
I also designed a [PVC Enclosure]({{ folder }}/Enclosure/Enclosure.svg){:target="_blank" rel="noopener"} made via [Ponoko Services](https://www.ponoko.com){:target="_blank" rel="noopener"}.

## Code ##
see files [here]({{ folder }}){:target="_blank" rel="noopener"}
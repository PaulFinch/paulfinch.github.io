...
![Proxy]({{ site.baseurl }}/assets/{{ folder }}/Images/proxy.png)
...
![SwitchyOmega]({{ site.baseurl }}/assets/{{ folder }}/Images/SwitchyOmega.jpg)

I created 3 profiles for ports 5000, 5001 and 5002:

![SwitchyOmegaConfig]({{ site.baseurl }}/assets/{{ folder }}/Images/SwitchyOmegaConfig.png)